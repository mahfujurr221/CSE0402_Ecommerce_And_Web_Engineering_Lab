   ...
   <!--------------start of breakcrub------------->
     ...
     <div id="content">
         <div class="container">
                ...
                <div id="contact" class="col-md-9 text-center">
                     <div class="row mt-4">
                        <div class="box m-auto pt-md-4 px-md-5">
                            <div class="box-header">
                                <h3>Feel Free To Contact With Us</h3>
                                <p class="text-muted">If you have any question, feel free to contact with us. Our customer service work<strong> 24/7</strong></p>
                            </div>
                            
                            <form class="contact.php" method="post">
                                 <div class="form-group">
                                    <input type="text" class="form-control text-center" aria-describedby="emailHelp" placeholder="Your Name">
                                  </div>
                                  
                                  <div class="form-group">
                                    <input type="email" class="form-control text-center" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Your email">
                                  </div>
                                  <div class="form-group">
                                    <input type="text" class="form-control text-center"  placeholder="Subject">
                                  </div>
                                  <textarea name="message" class="form-control text-center" id="" rows="05" placeholder="Message"></textarea>
                                  <button type="submit" class="btn btn-primary">
                                      <i class="fa fa-user"></i><span>Send Message</span>
                                  </button>
                            </form>
